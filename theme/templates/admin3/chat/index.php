<?
	...
	include('../../../chat_scripts/library.php');
	...
	$filter_primary = isset($_POST['filter_primary']) && $_POST['filter_primary'] != '' ? $_POST['filter_primary'] : "01/01/2015 - 01/30/2015";
...
<!-- BEGIN GLOBAL MANDATORdateY STYLES -->
	...
	<div class="page-content">
		<div class="container">
			...
			<!-- /.modal -->
							...
							<div class="modal fade bs-modal-full" id="verbatim-modal" tabindex="-1" role="dialog" aria-hidden="true">
								<div class="modal-dialog modal-full">
									<div class="modal-content">
										<div class="modal-header">
											<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
											
											<h4 class="modal-title font-blue-steel"><i class="glyphicon glyphicon-comment"></i>&nbsp<b>Verbatims<b></h4>
										</div>
										<div class="modal-body font-normal" id="verbatims">
											 <table class='table table-striped table-bordered2 table-hover' id='table'>
												 <thead>
												 	<tr>
													 	<th class="bg-blue-steel text-center">
													 		Date
													 	</th>
													 	<th  class="bg-blue-steel text-center">
													 		Agent
										...
										<div class="modal-footer">
											<button type="button" class="btn default blue-steel" data-dismiss="modal">Close</button>
										</div>
									</div>
									<!-- /.modal-content -->
								</div>
...
jQuery(document).ready(function() {    
   ...
   $('.progress .progress-bar').progressbar({display_text: 'fill'});
	...
	function viewVerbatims(item) {
	    
	    var error = '';

	    	/*$.ajax({
                  async: false,
                  url: '../../../chat_scripts/get_verbatims.php',
                  type: 'post',
